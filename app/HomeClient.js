        ...
        <main className="overflow-hidden text-[#2f241b]">
            ...
            <section className="mx-auto max-w-7xl px-3 py-6 sm:px-6 sm:py-14 lg:px-8">
                ...
                {hasGalleryItems ? (
                    <div
                        ref={marqueeRef}
                        className="marquee-strip rounded-[1rem] border border-[#6f8456]/20 bg-[linear-gradient(180deg,rgba(245,240,230,0.38),rgba(219,233,206,0.48),rgba(220,205,182,0.3))] shadow-[0_30px_100px_-60px_rgba(54,39,23,0.9)] backdrop-blur-2xl sm:rounded-[2.1rem]"
                    ...
                    <div className="rounded-[1rem] border border-[#6f8456]/20 bg-[linear-gradient(180deg,rgba(245,240,230,0.38),rgba(219,233,206,0.48),rgba(220,205,182,0.3))] p-8 text-center text-sm text-[#6f5843] backdrop-blur-2xl sm:rounded-[2.1rem]">
